...
## iOS 1.0 review posture (2026-09-06, version 1.0 build 34)
...
- Build number = CURRENT_PROJECT_VERSION (34 for this submission — it carries Sign in with Apple token revocation + the `PrivacyInfo.xcprivacy` privacy manifest; 33 was built, uploaded and attached in ASC on 2026-09-07 and GitHub master already carries it, so 34 is the first number Codemagic may fire; 32 was superseded the same day by the cloud-e2e proxy patch); see the TESTFLIGHT TRIGGER WARNING below before syncing.
