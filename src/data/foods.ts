...
export const FOODS: FoodEntry[] = [
  ...
  // brachos.org/brachos/falafel/: "The Bracha Rishona on Falafel Balls is Shehakol, and the Bracha Acharona is Borei Nefashos" (in a pita: Hamotzi + Birkat Hamazon). Added 2026-09-22 after the learned DB had picked up Ha'adama off the chickpeas page.
  f({ key: 'falafel', names: ['falafel', 'falafel balls', 'falafel ball', 'fried chickpea balls'], category: 'Other', brachaRishona: 'Shehakol', brachaAchrona: 'BoreiNefashos', shivasHaminim: false, isFiveGrain: false, isTreeFruit: false, isWineGrape: false, notes: 'Falafel balls are Shehakol with Borei Nefashos after (brachos.org). Eaten in a pita, the pita is Hamotzi and covers the falafel — Birkat Hamazon after.', source: 'brachos.org' }),
  ...
  // generic juice + wellness shots (owner report 2026-08-11: a ginger-cayenne
  // juice shot was mapped to the ginger PRODUCE entry → Ha'adama; extracted
  // juice is Shehakol like every non-grape juice — same OU rule as the named
  // juices above)
  f({ key: 'vegetable_juice', names: ['vegetable juice', 'green juice', 'celery juice', 'beet juice', 'cold-pressed juice', 'pressed juice', 'juice', 'cucumber juice', 'kale juice'], category: 'Beverages', brachaRishona: 'Shehakol', brachaAchrona: 'BoreiNefashos', shivasHaminim: false, isFiveGrain: false, isTreeFruit: false, isWineGrape: false, isDrink: true, notes: 'Extracted juice loses the produce’s bracha — every juice except grape is Shehakol (OU).', source: 'OU' }),
  f({ key: 'wellness_shot', names: ['ginger shot', 'wellness shot', 'immunity shot', 'juice shot', 'ginger juice', 'ginger cayenne juice', 'turmeric shot', 'lemon ginger shot', 'ginger turmeric shot'], category: 'Beverages', brachaRishona: 'Shehakol', brachaAchrona: 'BoreiNefashos', shivasHaminim: false, isFiveGrain: false, isTreeFruit: false, isWineGrape: false, isDrink: true, notes: 'A pressed-juice shot is a drink: Shehakol, like all juices except grape (OU).', source: 'OU' }),
